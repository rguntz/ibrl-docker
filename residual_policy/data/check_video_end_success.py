...
def replay_last_5_seconds(video_path):
    """
    Plays the last 1 seconds of the video in a loop until
    ...
    # Extract last 1 seconds as frames
...
video_folder = "/home/qtf5422/.cache/huggingface/lerobot/ankile/dexmg-two-arm-coffee/videos/chunk-000/observation.images.agentview"
process_videos_in_folder(video_folder, json_path="/home/qtf5422/Desktop/AIRE/residual-offpolicy-rl/resfit/lerobot/scripts/video_results.json")