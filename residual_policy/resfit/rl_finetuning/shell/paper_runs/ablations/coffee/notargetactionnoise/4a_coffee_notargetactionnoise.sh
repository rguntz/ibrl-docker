...
python -m resfit.rl_finetuning.scripts.train_residual_td3 \
    ...
    wandb.name=notargetactionnoise \
    wandb.notes=paper_runs/ablations/coffee/notargetactionnoise/4a_coffee_notargetactionnoise \
    wandb.group=notargetactionnoise \
    debug=false
