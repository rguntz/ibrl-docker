...
class DiffusionModel(nn.Module):
    ...
    def _prepare_global_conditioning(self, batch: dict[str, Tensor]) -> Tensor:
        ...
        if self.config.env_state_feature: 
            global_cond_feats.append(batch[OBS_ENV_STATE])   # OBS_STATE = "observation.state"
...
class DiffusionRgbEncoder(nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        # save_dir = "/home/qtf5422/Desktop/AIRE/residual-offpolicy-rl/image_encoded/testing"
        # os.makedirs(save_dir, exist_ok=True)
        # for i, img_tensor in enumerate(x):
        #     rand_num = random.randint(1000, 9999)  # random 4-digit number
        #     save_path = os.path.join(save_dir, f"img_{i}_{rand_num}.png")
        #     save_image(img_tensor, save_path)  # expects (C, H, W)
