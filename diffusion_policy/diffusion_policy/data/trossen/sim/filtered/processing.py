...
# normalize_gripper_in_file(input_path=file_original, output_path="dataset_1_norm_gripper.hdf5")
# inspect_right_arm(file="dataset_1_norm_gripper.hdf5")
# process_dataset(input_file="dataset_1_norm_gripper.hdf5", output_file="dataset_1_norm_gripper_tresholded.hdf5", threshold=0.01)
