...
# filter_initial_static_states(input_file="dataset_1.hdf5", output_file="dataset_1_tresholded.hdf5", threshold=0.01)
# inspect_right_arm(file="dataset_1_tresholded.hdf5")
# normalize_gripper_in_file(input_path="dataset_1_tresholded.hdf5", output_path="dataset_1_norm_gripper_tresholded.hdf5")
# inspect_right_arm(file="dataset_1_norm_gripper_tresholded.hdf5")
# modify_rewards_and_create_dones(input_path="dataset_1_norm_gripper_tresholded.hdf5", output_path="dataset_1_norm_gripper_tresholded_wr.hdf5")
# inspect_right_arm(file="dataset_1_norm_gripper_tresholded_wr.hdf5")
# truncate_demos_at_k_dones(input_path= "dataset_1_norm_gripper_tresholded_wr.hdf5", output_path = "dataset_1_norm_gripper_tresholded_wr_end_cut.hdf5", k = 1)
# inspect_right_arm(file="dataset_1_norm_gripper_tresholded_wr_end_cut.hdf5")
# convert_quat_to_angle_axis_in_dataset(input_path="dataset_1_norm_gripper_tresholded_wr_end_cut.hdf5", output_path="dataset_1_norm_gripper_tresholded_wr_end_cut_angle_axis.hdf5")
# inspect_right_arm_angle_axis(file="dataset_1_norm_gripper_tresholded_wr_end_cut_angle_axis.hdf5")
# transpose_image_dimensions(input_path="dataset_1_norm_gripper_tresholded_wr_end_cut_angle_axis.hdf5", output_path="dataset_1_norm_gripper_tresholded_wr_end_cut_angle_axis_image_transposed.hdf5")
inspect_right_arm_angle_axis(file="dataset_1_norm_gripper_tresholded_wr_end_cut_angle_axis_image_transposed.hdf5")
# verify_image_dimensions(file_path="dataset_1_norm_gripper_tresholded_wr_end_cut_angle_axis_image_transposed.hdf5")

function_make_video(input_file="dataset_1_norm_gripper_tresholded_wr_end_cut_angle_axis_image_transposed.hdf5")