...
#####################################################################################################################################################################################
file_original = "dataset_small_distribution.hdf5"
inspect_right_arm(file_original)
filter_initial_static_states(input_file="dataset_small_distribution.hdf5", output_file="dataset_tresholded.hdf5", threshold=0.01)
