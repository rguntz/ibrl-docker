...
def inspect_right_arm(file):
    with h5py.File(file, "r") as f:
        ...
        robot0_eef_pos = obs["robot0_eef_pos"][:, 3:]       # last 3 dims → right arm
        robot0_eef_quat = obs["robot0_eef_quat"][:, 4:]     # last 4 dims → right arm
        robot0_gripper_qpos = obs["robot0_gripper_qpos"][:, 1:]  # last dim → right arm

        # Concatenate into single array for plotting
        right_arm_obs = np.concatenate([robot0_eef_pos, robot0_eef_quat, robot0_gripper_qpos], axis=1)
        right_arm_action = action[:, 8:]  # last 8 dims → right arm
        num_dims = right_arm_obs.shape[1]
        steps = range(right_arm_obs.shape[0])

        # --- Plot right arm EE pose, quaternion, gripper vs. action ---
        ...
        plt.suptitle("Right Arm End-Effector Pose, Quaternion, and Gripper (Obs vs Action)")
...
# file_original = "/home/qtf5422/Desktop/AIRE/ibrl-docker/data/cube_picking_and_placing_ee/dataset.hdf5"
# inspect_right_arm(file_original)
# process_dataset(file_original, output_file="/home/qtf5422/Desktop/AIRE/ibrl-docker/data/cube_picking_and_placing_ee/dataset_tresholded.hdf5", threshold=0.05)
# inspect_right_arm(file="/home/qtf5422/Desktop/AIRE/ibrl-docker/data/cube_picking_and_placing_ee/dataset_tresholded.hdf5")
# modify_rewards_and_create_dones(input_path="/home/qtf5422/Desktop/AIRE/ibrl-docker/data/cube_picking_and_placing_ee/dataset_tresholded.hdf5", output_path="/home/qtf5422/Desktop/AIRE/ibrl-docker/data/cube_picking_and_placing_ee/dataset_tresholded_wr.hdf5")
inspect_keys(file="/home/qtf5422/Desktop/AIRE/ibrl-docker/data/cube_picking_and_placing_ee/dataset_tresholded_wr.hdf5")
inspect_right_arm(file="/home/qtf5422/Desktop/AIRE/ibrl-docker/data/cube_picking_and_placing_ee/dataset_tresholded_wr.hdf5")