...
class Trossen_env : 
    ...
    def reset(self) : 
        ...
        print("moving the robots to home")
    ...
    def step(self, action): 
        ...
        self.send_cartesian_command(self.follower_left, left_pose, left_gripper, robot_id='follower_left')
        self.send_cartesian_command(self.follower_right, right_pose, right_gripper, robot_id='follower_right')
...
class CartesianTeleopController:
    ...
    def run_dual_arm_teleop(
        ...
        self.env = Trossen_env(leader_left_ip, follower_right_ip, self.control_dt)
        ...
        try:
            while True:
                ...
                # get the action from the leader and step. 
                action = np.concatenate([left_pose, np.array([left_gripper]), right_pose, np.array([right_gripper])])
