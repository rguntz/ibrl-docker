...
class Trossen_env : 
    ...
    def send_cartesian_command(
        ...
        target_pose = np.round(target_pose, 2)
        print("target_pose : ", target_pose, "robot_id" , robot_id)
        ...
        try:
            ...
            #         num_trajectory_check_samples = 10,
            #         blocking=False
            #     )
        ...
        try:
            driver.set_gripper_position(gripper_pos, goal_time=0.5, blocking=True)
        except Exception as e:
