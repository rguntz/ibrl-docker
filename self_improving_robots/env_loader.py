...
def make(name, action_repeat, reward_type='sparse', height=84, width=84, num_frames=1):
	...
	if 'franka' in name: # not our case. 
	...
	else: # our case because this is the only data we have inside the folders. 
		...
		elif name == 'sawyer_door': # we are going to use this one because there are only forward demos which is our case. 
