...
process_dataset(input_file=file_original, output_file="dataset_1_tresholded.hdf5", threshold=0.01)
inspect_right_arm(file="dataset_1_tresholded.hdf5")
modify_rewards_and_create_dones(input_path="dataset_1_tresholded.hdf5", output_path="dataset_1_tresholded_wr.hdf5")
inspect_right_arm(file="dataset_1_tresholded_wr.hdf5")
shift_actions_with_clipping(input_path="dataset_1_tresholded_wr.hdf5", output_path="dataset_1_tresholded_wr_shifted.hdf5", k=3)
inspect_right_arm(file="dataset_1_tresholded_wr_shifted.hdf5")
convert_actions_to_delta(input_path="dataset_1_tresholded_wr_shifted.hdf5", output_path="dataset_1_tresholded_wr_shifted_delta.hdf5")
plot_right_arm_delta_actions(file= "dataset_1_tresholded_wr_shifted_delta.hdf5")
normalize_gripper_in_file(input_path="dataset_1_tresholded_wr_shifted_delta.hdf5", output_path="dataset_1_tresholded_wr_shifted_delta_gripper_normed.hdf5")
plot_right_arm_delta_actions(file="dataset_1_tresholded_wr_shifted_delta_gripper_normed.hdf5")
truncate_demos_at_k_dones(input_path="dataset_1_tresholded_wr_shifted_delta_gripper_normed.hdf5", output_path="dataset_1_tresholded_wr_shifted_delta_gripper_normed_cut_end.hdf5", k=8)
plot_right_arm_delta_actions(file="dataset_1_tresholded_wr_shifted_delta_gripper_normed_cut_end.hdf5", output_json="delta_action_stats.json")
normalize_delta_actions_from_json(input_path="dataset_1_tresholded_wr_shifted_delta_gripper_normed_cut_end.hdf5", output_path="dataset_1_tresholded_wr_shifted_delta_gripper_normed_cut_end_normalized.hdf5", json_stats_path="delta_action_stats.json")
plot_right_arm_delta_actions(file="dataset_1_tresholded_wr_shifted_delta_gripper_normed_cut_end_normalized.hdf5")
